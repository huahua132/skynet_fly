...
case "$perladmin" in
'') perladmin='root@wwh-5-128.q1oa.com' ;;
esac
...
case "$siteprefix" in
'') if test "/root/localperl" = "/root/localperl"; then
	siteprefix="$prefix"
    else
...
#     /root/localperl, so it isn't included here either.
#
...
# privlib='/root/localperl/lib/5.40.0'
# archlib='/root/localperl/lib/5.40.0/x86_64-linux'
# man1dir='/root/localperl/man/man1'
# man3dir='/root/localperl/man/man3'
# man1ext='1'
# man3ext='3'
...
# sitelib='/root/localperl/lib/site_perl/5.40.0'
# sitearch='/root/localperl/lib/site_perl/5.40.0/x86_64-linux'
# siteman1dir='/root/localperl/man/man1'
# siteman3dir='/root/localperl/man/man3'
# sitehtml1dir=''
# sitehtml3dir=''
# vendorbin=''
# vendorscript=''
