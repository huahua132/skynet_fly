return {
	...
	room_game_table_m = {
		...
		mod_args = {
			...
			{instance_name = "room_4", table_plug = "table.table_plug", table_conf = {player_num = 2,}},
			{instance_name = "room_5", table_plug = "table.table_plug", table_conf = {player_num = 2,}},
			{instance_name = "room_6", table_plug = "table.table_plug", table_conf = {player_num = 2,}},
		},
	},
