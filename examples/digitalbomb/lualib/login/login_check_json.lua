...
function M.logining(fd,player_id)
	errors_msg_json.errors(fd,errorcode.LOGINING,"logining please waiting...")
end

--重复登录
function M.repeat_login(fd,player_id)
	errors_msg_json.errors(fd,errorcode.REPAET_LOGIN,"repeat_login")
end
